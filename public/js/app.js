...
/* WEBPACK VAR INJECTION */(function($) {var axios = __webpack_require__(15);
(function () {
  var app = {
    init: function init() {
      this.listeners();
    ...
    getValues: function getValues(e) {
      e.preventDefault();
      var data = {};
      $('input').each(function () {
    ...
    sendData: function sendData(data) {
      axios.post('/api/simplonien/add', data).then(function (response) {
